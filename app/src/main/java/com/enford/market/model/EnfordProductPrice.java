...
public class EnfordProductPrice implements Parcelable {
    /**
    ...
    protected EnfordProductPrice(Parcel in) {
        ...
        this.miss = (Integer) in.readValue(Integer.class.getClassLoader());
        ...
        this.uploadBy = (Integer) in.readValue(Integer.class.getClassLoader());
        long tmpUploadDt = in.readLong();
        this.uploadDt = tmpUploadDt == -1 ? null : new Date(tmpUploadDt);
        ...
        this.missDesp = in.readString();
        this.uploadName = in.readString();
        this.promptPrice = (Float) in.readValue(Float.class.getClassLoader());
        this.remark = in.readString();
    }

    public static final Creator<EnfordProductPrice> CREATOR = new Creator<EnfordProductPrice>() {
        public EnfordProductPrice createFromParcel(Parcel source) {
            return new EnfordProductPrice(source);
        }

        public EnfordProductPrice[] newArray(int size) {
            return new EnfordProductPrice[size];
        }
    };
}